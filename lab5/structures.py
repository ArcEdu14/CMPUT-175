...
time conversion functions, the song, and music_queue class for the music player
"""
...
class MusicQueue: 
    ...
    def enqueue_b(self, item: Song): 
        ...
        Returns: None
        Working:
        This function enqueues the Song object to the back of the queue
        '''
        self.items.append(item)
        self.length += item.get_duration()  # add song length to queue length
    ...
    def dequeue(self):        
        ...
        if self.is_empty():
            ...
            song = self.items.pop(0)  # pop from top of queue
            self.length -= song.get_duration() # remove song length to queue length
            return song
    ...
    def peek(self):
        ...
        if self.is_empty():
            ...
            return self.items[0]  # peek from top of queue
